...
const AboutMe = () => {
  return (
    <div className="about-container">
      <div className="intro">
        ...
        <div className="text">
          ...
          <p>
            ...
            certyfikowanym terapeutą miofunkcjonalnym.{" "}
          </p>
          <p>
      ...
      <p>
        • Terapia miofunkcjonalna w wieku 9-99 lat ze specjalną terapią zaburzeń
        artykulacyjnych głosek s/sz wg A. Kittel.
      </p>
      <p>• Rotacyzm – diagnoza i efektywna terapia logopedyczna.</p>
      <p>• Ankyloglosja – terapia przed i po zabiegu.</p>
      <p>
        • Seplenienie międzyzębowe – diagnoza, metody korekcji, terapia na
        podstawie głosek szeregu syczącego.
      </p>
